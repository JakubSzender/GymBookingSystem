    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Machine",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Machine1" });

            migrationBuilder.InsertData(
                table: "Machine",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "Machine2" });

            migrationBuilder.InsertData(
                table: "Machine",
                columns: new[] { "Id", "Name" },
                values: new object[] { 3, "Machine3" });

            migrationBuilder.InsertData(
                table: "Machine",
                columns: new[] { "Id", "Name" },
                values: new object[] { 4, "Machine4" });

            migrationBuilder.InsertData(
                table: "Machine",
                columns: new[] { "Id", "Name" },
                values: new object[] { 5, "Machine5" });

            migrationBuilder.InsertData(
                table: "Machine",
                columns: new[] { "Id", "Name" },
                values: new object[] { 6, "Machine6" });
